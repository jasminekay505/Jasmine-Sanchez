            ...
            <div className = "row">
                <div className="col-md-4">
                    ...
                    <ul className="list-group">
                        <a href="#" className="list-group-item list-group-item-action"><img src="https://img.icons8.com/nolan/64/email.png" class="icon" />jasminekay505@gmail.com</a>
                        <a href="#" className="list-group-item list-group-item-action"><img src="https://img.icons8.com/nolan/64/phone.png" class="icon" /> 505.681.0535</a>
